...
@section('content')
	...
	<nav class="navbar navbar-dark bg-dark fixed-top">
  		<a class="navbar-brand align-middle" href="{{route('AdminIndex')}}">
				...
				<div class="form-row">
					<div class="form-group col-md-4">
    					<label for="name">Nombre Categoría</label>
   						<input type="text" class="form-control" id="name" name="name" aria-describedby="emailHelp" value="{{ $category->name }}" placeholder="Introduce el nombre de la categoría">
